$(document).ready(function(){
	...
	.done(function(response) {
        if(response.list.length==0){
			...
			texthtml = texthtml + '			<input type="checkbox" class="form-check-input position-static font-smsm" data-id-format="id_OrderingId-%d-DELETE" data-name-format="OrderingId-%d-DELETE" id="id_OrderingId-0-DELETE" name="OrderingId-0-DELETE">';
			texthtml = texthtml + '		</div>';
			texthtml = texthtml + '	</td>';
			texthtml = texthtml + '	<td><input type="tel" class="form-control ResultItemNumber font-smsm" autocomplete="new-password" style="text-align: right;" data-id-format="id_OrderingId-%d-ResultItemNumber" data-name-format="OrderingId-%d-ResultItemNumber" name="OrderingId-0-ResultItemNumber" id="id_OrderingId-0-ResultItemNumber" value=' + result + '></td>';
			texthtml = texthtml + '	<td><input type="tel" class="form-control ResultDate font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ResultDate" data-name-format="OrderingId-%d-ResultDate" name="OrderingId-0-ResultDate" id="id_OrderingId-0-ResultDate" value=""></td>';
			texthtml = texthtml + '	<td><input type="tel" class="form-control ShippingDate font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ShippingDate" data-name-format="OrderingId-%d-ShippingDate" name="OrderingId-0-ShippingDate" id="id_OrderingId-0-ShippingDate" value=""></td>';                                  
			texthtml = texthtml + '	<td><input type="tel" step="0.1" class="form-control ShippingVolume text-right font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ShippingVolume" data-name-format="OrderingId-%d-ShippingVolume" name="OrderingId-0-ShippingVolume" id="id_OrderingId-0-ShippingVolume" data-empty-val="false" onchange="financial_shipp(this);" value="0.00"></td>';
			texthtml = texthtml + '	<td><input type="tel" class="form-control SlipNumber text-right font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-SlipNumber" data-name-format="OrderingId-%d-SlipNumber" name="OrderingId-0-SlipNumber" id="id_OrderingId-0-SlipNumber" value=""></td>';
			texthtml = texthtml + '	<td><input type="text" class="form-control font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ResultSummary" data-name-format="OrderingId-%d-ResultSummary"	name="OrderingId-0-ResultSummary" id="id_OrderingId-0-ResultSummary" value=""}}></td>';
			texthtml = texthtml + '	<td class="text-center">';
			texthtml = texthtml + '		<div class="form-check">';
		...
		$.each(response.list, function(index, list) {
			...
			texthtml = texthtml + '	<td><input type="tel" class="form-control ResultDate font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ResultDate" data-name-format="OrderingId-%d-ResultDate" name="OrderingId-' + index + '-ResultDate" id="id_OrderingId-' + index + '-ResultDate" value="' + list.ResultDate + '"></td>';
			texthtml = texthtml + '	<td><input type="tel" class="form-control ShippingDate font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ShippingDate" data-name-format="OrderingId-%d-ShippingDate" name="OrderingId-' + index + '-ShippingDate" id="id_OrderingId-' + index + '-ShippingDate" value="' + list.ShippingDate + '"></td>';                                  
			...
			texthtml = texthtml + '	<td><input type="tel" class="form-control SlipNumber text-right font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-SlipNumber" data-name-format="OrderingId-%d-SlipNumber" name="OrderingId-' + index + '-SlipNumber" id="id_OrderingId-' + index + '-SlipNumber" value="' + list.SlipNumber + '"></td>';
			texthtml = texthtml + '	<td><input type="text" class="form-control font-smsm" autocomplete="new-password" data-id-format="id_OrderingId-%d-ResultSummary" data-name-format="OrderingId-%d-ResultSummary"	name="OrderingId-' + index + '-ResultSummary" id="id_OrderingId-' + index + '-ResultSummary" value="' + list.ResultSummary + '"></td>';
			texthtml = texthtml + '	<td class="text-center">';
			texthtml = texthtml + '		<div class="form-check">';
